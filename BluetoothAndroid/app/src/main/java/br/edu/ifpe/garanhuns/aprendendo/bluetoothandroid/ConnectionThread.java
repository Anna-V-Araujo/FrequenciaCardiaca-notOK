...
/**
 * Created by Anna Vitória on 12/08/2016.
 */
public class ConnectionThread extends Thread{
    ...
    //Construtor para quando este dispositivo for o servidor
    ...
    //Construtor para quando este dispositivo for o Cliente. O parâmetro é o endereço MAC do disp. que ele quer se conectar
    ...
    //Contém as instruções que devem ser realizadas em uma nova thread
    public void run() {

        //Afirma que a thread está sendo executada
        this.running = true;
    ...
    private void toMainActivity(byte[] data) {
        ...
        ConfiguracaoActivity.handler.sendMessage(message);
    }
